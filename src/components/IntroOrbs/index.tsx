      ...
      >
        ...
        <section className="bg-introToOrbs relative w-full md:bg-cover bg-opacity-20 h-[100vh] md:min-h-screen">
          <div className="relative" id="dark_overlay">
            <h1 className="pt-12 pb-8 font-primary-semibold text-[48px] w-[70%] mx-auto md:w-full md:px-0 md:text-[52px] text-center text-transparent bg-gradient-to-r bg-clip-text from-start-gradient to-end-gradient leading-tight">
              {INTRO_ORBS_HEADLINE}
            </h1>
          </div>
          <Wallet />
