...
function FourthGrid() {
  ...
  return (
    <motion.div
      className="col-span-1 md:col-span-2 row-span-2 bg-[#141417] text-white text-xl grid-border-gradient-secondary md:h-[269px] xl:h-[380px] overflow-hidden"
      style={{
        background:
    ...
    >
      <div className="flex flex-col justify-between gap-4 md:gap-0 h-full w-full items-center">
        <h1 className="font-primary-regular md:self-start self-center text-center text-[32px] md:text-[22px]  xl:text-2xl leading-8 tracking-wide md:text-start xl:w-[55%] px-6 pt-6">
        ...
        <div className="border-gradient-light w-[90%] md:w-[70%] xl:w-[80%] bg-cardBg mt-8 md:mt-0 -mb-4">
          <div className="p-4">
