...
function ThirdGrid() {
  ...
  return (
    <motion.div
      className="flex col-span-1 row-span-2 justify-center bg-gradient-to-b from-[#141417] from-80% to-[#5110107A] text-white text-xl grid-border-gradient-secondary md:h-[344px]"
      style={{
        background:
