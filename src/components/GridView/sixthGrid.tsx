...
function SixthGrid() {
  ...
  return (
    <motion.div
      className="flex col-span-1 row-span-2 justify-center bg-[#141417] text-white text-xl relative h-[40vh] grid-border-gradient-secondary md:h-[300px] md:-mt-10"
      style={{
        background:
        ...
        <section className="w-full h-full relative md:py-4">
          <div className="h-full w-full">
            <img
              ...
              className="absolute bottom-[60%] md:bottom-[65%] left-[30px] h-[20%] w-[80%] md:h-[25%] md:w-full"
              alt="coinbase"
            />
            <img
              src={"/sixth_grid_moonpay.webp"}
              className="absolute bottom-[35%] md:bottom-[35%] md:left-[40px] left-[20%]  h-[20%] w-[80%] md:h-[25%] md:w-full"
              alt="moonpay"
            />
            <img
              src={"/sixth_grid_pancake.webp"}
              className="absolute bottom-[10%] md:bottom-[5%] md:left-[50px] left-[20%] h-[20%] w-[80%]  md:h-[25%]  md:w-full z-20"
              alt="pancake"
            />
