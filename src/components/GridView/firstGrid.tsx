...
function FirstGrid() {
  ...
  return (
    <motion.div
      className="flex col-span-1 md:col-span-3 row-span-1 md:h-[216px] justify-center items-center text-white text-xl p-8 relative grid-bg overflow-hidden grid-border-gradient"
      style={{
        background:
      ...
      <section className="relative flex flex-col-reverse md:flex-row justify-between h-full w-full items-center gap-28 md:gap-0">
        <div className="w-full md:w-1/2 h-full flex relative">
          <img
            ...
            alt="lines-left"
            className="absolute -top-24 -left-28 md:top-0 md:-left-8 w-[40%] md:w-[40%] scale-[1.3]"
          />
          <img
        ...
        <div className="md:w-[40%] z-10">
          <p className="font-primary-regular text-[30px] md:text-[38px] w-full text-center leading-10">
            {ENCRYPTION}
          </p>
        </div>
      </section>
