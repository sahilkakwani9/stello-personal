...
function FiveGrid() {
  ...
  return (
    <motion.div
      className="flex col-span-1 row-span-3 justify-between items-center bg-[#141417] text-white text-xl grid-border-gradient md:h-[520px] md:-mt-16 overflow-hidden"
      style={{
        background:
