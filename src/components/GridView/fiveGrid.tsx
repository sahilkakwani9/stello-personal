...
function FiveGrid() {
  ...
  return (
    <motion.div
      className="flex col-span-1 md:row-span-3 justify-between items-center bg-[#141417] text-white text-xl grid-border-gradient md:h-[310px] xl:h-[520px] md:-mt-16 overflow-hidden"
      style={{
        background:
    ...
    >
      <div className="pt-8 md:pt-4 flex flex-col justify-between h-full w-full items-center">
        ...
        />
        <h1 className="font-primary-medium text-[32px] md:text-[24px] xl:text-[32px] text-center px-2 mb-8 w-[80%]">
          Spin and win
