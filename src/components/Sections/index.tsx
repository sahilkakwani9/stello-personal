...
const sectionData = [
    {
      ...
      description: "Earn orbs effortlessly and watch your cashback soar! The more orbs you hold, the higher your cashback percentage. It's that simple, that exciting!",
      universalCashbackText: "Universal Cashback",
      crossChainBenefitsText: "Cross-Chain Benefits",
      mainImageSrc: "/sections_img_1.png",
      backgroundImageSrc1: "/sections_img_bg.png",
    ...
    },
    {
      ...
      description: "Discover the power of privacy and authority with our platform. Take control of your data and decisions, navigating the digital world with confidence. With us, your privacy is protected, your authority respected. Embrace empowerment in the digital age.",
    ...
    },
    {
      ...
      description: "Swap cryptocurrencies effortlessly, without any fees. Enjoy seamless transactions and maximize your assets without worrying about extra charges. Experience the freedom of fee-free crypto swapping today!",
